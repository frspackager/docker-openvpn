...
* To modify the data, you can also mount the data container and modify it with
        ...
        docker run --rm -it -v $OVPN_DATA:/etc/openvpn frspackager/openvpn bash -l
...
1. Get the container's name or container ID:
        ...
        ed335aaa9b82        frspackager/openvpn:latest   ovpn_run            5 minutes ago       Up 5 minutes        0.0.0.0:1194->1194/udp   sad_lovelace
